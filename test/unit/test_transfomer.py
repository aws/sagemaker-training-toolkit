...
from sagemaker_training_toolkit import _content_types, _env, _errors, _transformer
import test


@patch("sagemaker_training_toolkit._encoders.decode")
...
@patch("sagemaker_training_toolkit._encoders.encode", lambda prediction, accept: prediction ** 2)
...
@patch("sagemaker_training_toolkit._worker.Request", lambda: request)
...
def test_transformer_transform_with_unsupported_content_type():
    ...
    with patch("sagemaker_training_toolkit._worker.Request", lambda: bad_request):
...
@patch(
    "sagemaker_training_toolkit._worker.Request",
