...
from sagemaker_training_toolkit import _env, _errors, _files, _modules, _params
...
@patch("sagemaker_training_toolkit._process.python_executable")
@patch("sagemaker_training_toolkit._process.check_error")
...
@patch("sagemaker_training_toolkit._process.python_executable")
@patch("sagemaker_training_toolkit._process.create")
@patch("sagemaker_training_toolkit._logging.log_script_invocation")
...
@patch("sagemaker_training_toolkit._modules.run")
@patch("sagemaker_training_toolkit._modules.install")
@patch("sagemaker_training_toolkit._env.write_env_vars")
...
def test_download_and_install_local_directory():
    ...
    with patch("sagemaker_training_toolkit._files.s3_download") as s3_download, patch(
        "sagemaker_training_toolkit._modules.prepare"
    ) as prepare, patch("sagemaker_training_toolkit._modules.install") as install:
