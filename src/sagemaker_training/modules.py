...
def _get_codeartifact_index():
    """
    Build the authenticated codeartifact index url based on the arn provided via CA_REPOSITORY_ARN environment variable
    following the form `arn:${Partition}:codeartifact:${Region}:${Account}:repository/${DomainName}/${RepositoryName}`
