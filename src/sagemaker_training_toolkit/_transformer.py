...
from sagemaker_training_toolkit import _content_types, _encoders, _env, _errors, _functions, _worker
...
class Transformer(object):
    ...
    Examples:
    >>>import os
    >>>from sagemaker_training_toolkit import _env, _modules, _transformer
    >>>import Keras
    ...
    def initialize(self):  # type: () -> None
        ...
        This function is called by sagemaker_training_toolkit.beta.framework.worker.Worker,
    ...
    def transform(self):  # type: () -> _worker.Response
        ...
        Returns:
            sagemaker_training_toolkit.beta.framework.worker.Response: a Flask response object with
                the following args:
    ...
    def _default_transform_fn(self, model, content, content_type, accept):
        ...
        Returns:
            sagemaker_training_toolkit.beta.framework.worker.Response or tuple:
